...
Run GO analysis on the differentially methylated regions (DMRs) identified using the *DMRcate* package for each of the contrasts.
...
fig <- here("output/figures/SFig-10F.rds")
saveRDS(p[[2]], fig, compress = FALSE)
