...
4.
    ...
    b) [Generate a breast cancer cell-line RNAseq "truth" set](04_expressionGenesetsCellLines.html)
    Analyse an RNAseq breast cancer cell-line dataset and identify the top ranked 
    gene sets for each cell type comparison.
    
    c) [Generate a uterine fibroid RNAseq "truth" set](04_expressionGenesetsFibroid.html)
