...
3a. [Generate a blood cell RNAseq "truth" set](03_expressionGenesets.html)
    * Analyse an RNAseq sorted blood cell dataset and identify the top ranked 
      gene sets for each cell type comparison.

3b. [Generate a breast cancer cell-line RNAseq "truth" set](03_expressionGenesetsNew.html)
...
5a. [Compare performance of different methods](05_exploreData.html)
...
5b. [Compare performance of different methods](05_exploreDataNew.html)
