...
3. 
    a) [Compare FDR of different methods (KIRC)](03_fdrAnalysisKIRC.html)
    ...
    b) [Compare FDR of different methods (BRCA)](03_fdrAnalysisBRCA.html)
...
4.
    ...
    b) [Generate a breast cancer cell line RNAseq "truth" set](04_expressionGenesetsFibroid.html)
    Analyse an RNAseq breast cancer cell line data and identify the top ranked 
    gene sets for each comparison.
    
    c) [Generate a uterine fibroid RNAseq "truth" set](04_expressionGenesetsCellLines.html)
    Analyse an RNAseq normal and fibroid uterine tissue dataset and identify the top ranked 
    gene sets for each tissue comparison.
    
    d) [Generate a B-cell development gene exression "truth" set](04_expressionGenesetsBcells.html)
...
5.
    a) [Compare performance of different methods](05_compareMethods.html)
    ...
    b) [Compare performance of different methods](05_compareMethodsCellLines.html)
    Analyse an EPIC array breast cancer cell line data using various gene set 
    testing methods. Compare how well the different methods perform using several 
    metrics.
    
    c) [Compare performance of different methods](05_compareMethodsFibroid.html)
    Analyse an EPIC array normal and fibroid uterine tissue dataset using various gene set 
    testing methods. Compare how well the different methods perform using several 
    metrics.
    
    d) [Compare performance of different methods](05_compareMethodsBcells.html)
...
7. 
    a) [Evaluate GOregion (Sorted blood cell data)](07_regionAnalysis.html)
    ...
    b) [Evaluate GOregion (B-cell development data)](07_regionAnalysisBcells.html)
    Evalulate GOregion, our extension of gometh for geneset testing of 
    differentially methylated regions (DMRs) identified by DMR finding software.
