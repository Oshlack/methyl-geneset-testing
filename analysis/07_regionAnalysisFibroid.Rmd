...
We are using publicly available EPIC data [GSE135446](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE135446) generated from normal and fibroid uterine tissue. The data is normalised and filtered (bad probes, multi-mapping probes, SNP probes, sex chromosomes).
...
outFile <- here("data/cache-region/dmrcate-results-GSE135446.rds")
...
```{r}
outFile <- here("data/cache-region/dmrcate-go-GSE135446.rds")
