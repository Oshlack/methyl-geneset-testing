...
inFile <- here::here("data/cache-runtime/run-time-results.rds")
...
if(!file.exists(inFile)){
    ...
    load(here::here('data/cache-intermediates/blood.contrasts.rData'))
    bVals <- ilogit2(mVals)
    ...
    for(i in 1:ncol(tfit$contrasts)){
        ...
        tic("mgsa.glm")
        res <- methylGSA::methylglm(cpg.pval = tfit$p.value[,i],
